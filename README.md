...
- [x] Web application을 위한 [`WebData`](https://github.com/drbae/WebData){:target="_blank" rel="noopener"}
...
- [x] 데이터 분석/관리 Web Application [`WdmServer`](https://github.com/drbae/WdmServer){:target="_blank" rel="noopener"} (ASP.NET Core)
